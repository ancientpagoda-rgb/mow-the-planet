...
- Camera: drag to orbit smoothly around the planet, pinch or scroll to change distance, and release to coast gently. On desktop, right- or middle-drag anchors the camera position while pivoting the view. Tap **◎** for a globe overview. **SURFACE** enters the founding rider's true first-person POV; drag looks around, pinch/scroll adjusts the field of view, and **RETURN** restores the previous free-camera pose.
