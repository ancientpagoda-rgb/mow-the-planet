...
function restoreSettlement() { const snapshot = safeParse(localStorage.getItem(SAVE_STORAGE_KEY), null); if (snapshot?.version === 2) globalThis.__mowRuntime?.restore?.(snapshot); }
